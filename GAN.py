...
class GAN(k.Model):
  def __init__(self,channels=5,kernel_size=3,noise_mean=0.0, noise_stddev=.1, do_batch_norm:bool=False, batch_norm_alpha=.5, name='GAN', visualizer=None,use_noise=False,**kwargs):
